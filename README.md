...
+ Modifier le fichier **php.ini** de WampServer et ajouter la localisation de **sendmail.exe** à **sendmail_path =** (par exemple: "C:\wamp64\sendmail\sendmail.exe") ![php.ini](https://john-dugan.com/wp-content/uploads/2014/07/update-php-wamp-php-ini.png)
+ 
